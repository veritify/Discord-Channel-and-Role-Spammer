...
if Bot == True:
    client = commands.Bot(command_prefix="Veritify!", case_insensitive=False, self_bot=True, intents=intents)
else:
    client = commands.Bot(command_prefix="Veritify!", case_insensitive=False, intents=intents)
